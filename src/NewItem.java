...
public class NewItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/new_product.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 0, -1, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 650, 10));
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 157, 650, 10));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, 250, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("Price");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, -1, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, 250, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 270, 250, -1));

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Yes", "No" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 310, 250, -1));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 650, 10));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gradiant.jpg"))); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
           ...
           /* PreparedStatement ps=con.prepareStatement("select max(id) from items", DEFAULT_CURSOR, DISPOSE_ON_CLOSE);*/
             Statement st=con.createStatement();
             ResultSet rs=st.executeQuery("select max(id) from items");
             if(rs.next()){
                 int iid=rs.getInt(1);                 
                 iid=iid+1;
                 String str =String.valueOf(iid);
                 jLabel4.setText(str);
             }
             else{
                 JOptionPane.showMessageDialog(null,"else hello ");
                 jLabel4.setText("1");
             }
       }
       catch(Exception e){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                // TODO add your handling code here:
                 ...
                 try{
                    Connection con= ConnectionPrivider.getCon();
                    Statement st=con.createStatement();
                    st.executeUpdate("insert into items values('"+id+"','"+name+"','"+price+"','"+desc+"','"+available+"')");
